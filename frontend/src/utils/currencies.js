// World currencies in ascending alphabetical order by currency code
export const WORLD_CURRENCIES = [
  ...
  { code: 'BAM', name: 'Bosnia-Herzegovina Convertible Mark', symbol: 'КМ', country: 'Bosnia and Herzegovina' },
  ...
  { code: 'GEL', name: 'Georgian Lari', symbol: 'ლ', country: 'Georgia' },
  ...
  { code: 'ILS', name: 'Israeli New Sheqel', symbol: '₪', country: 'Israel' },
  ...
  { code: 'MMK', name: 'Myanma Kyat', symbol: 'Ks', country: 'Myanmar' },
  { code: 'MNT', name: 'Mongolian Tugrik', symbol: '₮', country: 'Mongolia' },
  { code: 'MOP', name: 'Macanese Pataca', symbol: 'P', country: 'Macao' },
  ...
  { code: 'PEN', name: 'Peruvian Nuevo Sol', symbol: 'S/', country: 'Peru' },
  ...
  { code: 'TVD', name: 'Tuvaluan Dollar', symbol: '$', country: 'Tuvalu' },
  ...
  { code: 'UZS', name: 'Uzbekistan Som', symbol: 'so\'m', country: 'Uzbekistan' },
  { code: 'VED', name: 'Venezuelan Bolívar Digital', symbol: 'Bs.D', country: 'Venezuela' },
  ...
  { code: 'XAF', name: 'Central African CFA Franc', symbol: 'Fr', country: 'Central African Republic' },
...
// Most popular currencies (for quick selection)
export const POPULAR_CURRENCIES = [
  'USD', 'EUR', 'GBP', 'JPY', 'CNY', 'INR', 'CAD', 'AUD', 'CHF', 'SEK',
  'NOK', 'MXN', 'SGD', 'HKD', 'NZD', 'TRY', 'RUB', 'BRL', 'ZAR', 'KRW'
];
